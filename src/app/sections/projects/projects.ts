...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="pointer-events-none absolute left-1/3 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-brand-600/10 blur-[130px]"
        aria-hidden="true"
      ></div>
                ...
                >
                  <div>
                    <span
                      ...
                      [class.text-brand-300]="project.accent === 'primary'"
